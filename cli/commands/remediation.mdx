...
| Gate | Behavior |
|------|----------|
| **Workload owned by Helm, ArgoCD, Flux, or kustomize** | **Declined, exit code `4`.** Prints the owner, the Deployment diff, and the owner-shaped steps. No `--force` exists. |
