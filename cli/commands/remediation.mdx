...
| `--workload` | string | auto-discovered | Explicit Deployment name, overriding the discovery chain |
...
# Disambiguate when discovery finds several Deployments or containers
