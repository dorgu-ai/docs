...
- **Cluster bootstrapping** — Interactive wizard installs a production-ready stack: cert-manager (v1.16.3), ingress-nginx (4.11.3), CloudNativePG (0.24.0), OpenObserve (0.60.0), Argo CD (7.8.28), and External Secrets (0.10.7)
