...
| Value | Type | Default | Description |
|-------|------|---------|-------------|
| `healthCheck.enabled` | bool | `false` | Enable the health-check reconciler — detection, diagnosis, and remediation proposals. **This is the switch that turns self-healing on.** |
