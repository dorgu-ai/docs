...
<Note>
  This page pins an exact chart version for reproducibility. Check [operator releases](https://github.com/dorgu-ai/dorgu-operator/releases) for the newest chart, or omit `--version` to always install the latest.
</Note>
...
# Deploy the operator
make deploy IMG=ghcr.io/dorgu-ai/dorgu-operator:0.7.2
```
