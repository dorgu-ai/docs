...
<Note>
  The platform is at v0.0.1 (MVP) and visualizes **ClusterPersona only** — there is no incident or remediation UI yet. Use the [`dorgu incidents`](/cli/commands/incidents) and `dorgu remediation` commands for the self-healing workflow.
</Note>
